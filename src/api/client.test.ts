...
import { apiDelete, apiGet, toCamelCase, toSnakeCase } from './client';
...
describe('api client error handling', () => {
  ...
  it('clears stored auth on 401 without redirecting', async () => {
...
describe('api client delete requests', () => {
  ...
  it('sends optional delete body using snake_case keys', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith('/v2/two-factor/disable', {
      method: 'DELETE',
